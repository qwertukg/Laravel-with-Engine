...
$model = IoC::resolve('CategoryModel');

IoC::register('categoriesEngineForm', function () use ($model, $lists) 
{
	$config = array(
		'languageFile' => 'categories',

		'components' => array(

			'title' => TextForm::make('title'),
			'description' => TextAreaForm::make('description'),
...
IoC::register('categoriesEngineGrid', function () use ($model, $lists) 
{
	$config = array(
		'languageFile' => 'categories',
		...
		'components' => array(
			...
			'description' => ColumnGrid::make('description'),
		...
		'filters' => array(
			...
			'description' => ContainsFilter::make('description'),
