 ...
 * @return string
 */
function laravel_document($page)
{
...
{
	$view->with('sidebar', laravel_document('contents'));
});
 ...
 */
Route::get('(:bundle)', array('as' => 'laravel_docs', function()
{
	return View::make('docs::page')->with('content', laravel_document('home'));
}));
 ...
 * @return mixed
 */
Route::get('(:bundle)/(:any)/(:any?)', array('as' => 'laravel_docs_more', function($section, $page = null)
{
	...
	{
		return View::make('docs::page')->with('content', laravel_document($file));
	}
	else
	{
